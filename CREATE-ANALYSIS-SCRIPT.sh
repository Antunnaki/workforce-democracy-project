...
cat > /var/www/workforce-democracy/analyze-backend-structure.sh << 'SCRIPT_EOF'
#!/bin/bash
...
# Make it executable
chmod +x /var/www/workforce-democracy/analyze-backend-structure.sh

# Run it
bash /var/www/workforce-democracy/analyze-backend-structure.sh

echo ""
echo "✅ Script created and executed!"
