/*WDP main.20251216T1000.js LIVE v20250125-PERFORMANCE-OPTIMIZED-V3 builtAt=2025-12-16T10:00Z TIMESTAMP-VERIFIED */
...
document.querySelectorAll('a[href^="#"]').forEach(anchor => {
        anchor.addEventListener('click', function (e) {
            ...
            if (href ==='#local') {
                ...
                // Ifpersonalization is enabled, scrollto interface instead of section
...
<input type="hidden" name="bot-field" />
                ...
                <div style="margin-bottom:20px;">
                    ...
                    <p style="font-size: 0.8125rem; color: var(--text-light); margin-top: 0.5rem; margin-bottom: 0;">
                        💡 <strong>Tip:</strong> If you want a response butwant to stayanonymous, you can provide an email without your real name, or use a temporary email service.
                    </p>
                </div>
