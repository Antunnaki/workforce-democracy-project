/*WDP main.20251216T1100.js LIVE v20250125-PERFORMANCE-OPTIMIZED-V3 builtAt=2025-12-16T11:00Z TIMESTAMP-VERIFIED */
...
function checkPersonalizationStatus() {
   // Migrate oldpersonalization data to new unified system
...
// These are nowhandled by personalization.js and the welcome modal system
...
function setupEventListeners() {
    ...
    console.log('✅ Click-outsidehandler disabled - menu closes via button toggle or language selection only');
...
document.querySelectorAll('a[href^="#"]').forEach(anchor => {
        anchor.addEventListener('click', function (e) {
            ...
            lettarget = document.querySelector(href);
            ...
            if (href ==='#local') {
                ...
                // Ifpersonalization is enabled, scrollto interface instead ofsection
...
const mobileNav = document.getElementById('mobileNav');
    if (mobileNav) {
        ...
        // Ifopening menu, add click-outside listener after a short delay
...
function handleClickOutsideMobileMenu(event) {
    constmobileNav = document.getElementById('mobileNav');
...
console.error('🚨🚨🚨 SOMETHING IS TRYING TO REMOVE ACTIVE CLASS! 🚨🚨🚨');
        ...
        // Check aftera brief moment if it's still active
        setTimeout(() => {
...
/**
 * @deprecated- Replaced by openLanguageModal()
 * Olddesktop dropdown toggle function - kept forreference only
 */
...
console.log('🔵 Ignoring duplicate click (within 300ms)');
        ...
        console.log('✅ Mobile language button listener attached (modalversion)');
   } else {
...
function closeModal() {
   const overlay = document.getElementById('modalOverlay');
   constcontainer = document.getElementById('modalContainer');
...
console.error('❌ changeLanguage function notavailable');
    }
}

// Make functionsglobally accessiblewindow.openLanguageModal = openLanguageModal;
...
right: 20px;
    ...
    notification.innerHTML = `
        <div style="display: flex; align-items: center; gap: var(--space-md);">
            <iclass="fas fa-${type === 'success' ? 'check-circle' : type === 'error' ? 'exclamation-circle' : 'info-circle'}"></i>
            <span>${message}</span>
        </div>
    `;
    ...
    // Auto-remove after 5 secondssetTimeout(()=> {
...
function showPrivacyPolicy() {
   const content = `
        <div style="max-width: 800px;">
            ...
            <h3>OurCommitment to Privacy</h3>
            <p>The Workforce Democracy Projectis committed to complete privacy and transparency. This policy explains our approach:</p>
...
<li>Language preferences</li>
            ...
            <ul>
                ...
                <li><strong>Right to Opt-Out:</strong>Allpersonalization features are optional</li>
            </ul>
...
functionshowSecurityInfo() {
    const content = `
        <div style="max-width: 800px;">
            ...
            <h4>🔒 Encryption</h4>
           <p>We use military-grade encryption to protectyourdata:</p>
            <ul>
            ...
            <p>Weactively protect against browser fingerprinting:</p>
            <ul>
...
async function exportUserData() {
    if (confirm('Export all your data? Thiswill download a JSONfile containing all your encrypted information.')) {
        try {
            showLoading();
...
async function deleteUserData() {
    if (confirm('⚠️ WARNING: This will permanentlydelete ALL your data from this device. This action cannot be undone. Are you sure?')) {
...
<input type="hidden" name="bot-field" />
                ...
                <div style="margin-bottom:20px;">
                    ...
                    <p style="font-size: 0.8125rem; color: var(--text-light); margin-top: 0.5rem; margin-bottom: 0;">
                        💡 <strong>Tip:</strong> If you want a response butwantto stayanonymous, you can provide an email without your real name, or use a temporary email service.
                    </p>
                </div>
...
<strong>Privacy Guarantee:</strong> Your message will be sent securely. We will never share your contact information.
                ...
                <p style="color:var(--text-light); font-size: 0.8125rem; margin: 0;">
                    ✨ <strong>Anonymous submissionsare welcome!</strong> You can leaveName and Email blank if you prefer to remain anonymous. Use your Submission ID to referenceyour message if needed.
                </p>
           </div>
        </div>
    `;
        ...
        <div class="guided-tour-overlay" id="guidedTourOverlay">
           <div class="guided-tour-content">
                <div class="tour-header">
                    ...
                    <p style="margin-top: 0.75rem; font-size: 1.1rem; opacity: 0.95;">Yourjourney to understanding democratic workplaces starts here</p>
                    ...
                    <div class="tour-step active" data-step="1">
                        ...
                        <div class="tour-features-grid">
                            ...
                            <div class="tour-feature-card">
                                ...
                                <div class="tour-feature-title">JobExploration</div>
...
<button class="btn btn-primary" onclick="nextTourStep()">
                    ...
                    <div class="tour-step" data-step="2">
                        ...
                        <div style="background: rgba(102, 126, 234, 0.05); padding: 1.5rem; border-radius: 12px; margin-bottom: 1.25rem; border-left: 4px solid #667eea;">
                            ...
                            <p style="margin: 0 0 0.75rem 0;"><strong style="color: #667eea;">✓</strong> Voteon bills yourself and compare with yourrepresentatives</p>
                        ...
                        <div class="tour-actions">
                           ...
                           <buttonclass="btn-link" onclick="skipGuidedTour()">Skip tour</button>
                        </div>
                    </div>
...
<div class="tour-feature-desc">Side-by-side comparisons of traditional vs democratic workplaces</div>
                        ...
                        <div class="tour-actions">
                            ...
                            <button class="btn-link" onclick="skipGuidedTour()">Skiptour</button>
                        </div>
                    </div>
                    ...
                    <div class="tour-step" data-step="4">
                        ...
                        <div style="display: grid; gap: 1rem; margin-bottom: 1.25rem;">
                            <div style="background: linear-gradient(135deg, rgba(102, 126, 234, 0.1) 0%, rgba(118, 75, 162, 0.1) 100%); padding: 1.25rem; border-radius: 12px; border: 2px solidrgba(102, 126, 234, 0.2);">
                                ...
                                <p style="margin: 0; font-size: 0.95rem;">Search for worker cooperatives, B-Corps, and democratically-run businesses near you. Chat with our assistantto find the perfect match.</p>
                            </div>
                     ...
                     <div class="tour-step-icon">✨</div>
                       ...
                       <div class="tour-personalization-input">
                        ...
                        <div style="background: rgba(102, 126, 234, 0.05); padding: 1.25rem; border-radius: 8px; margin-top: 1.25rem;">
                            <pstyle="margin: 0 0 0.5rem 0;font-weight: 600; color: #2d3748;">What gets remembered (locally only):</p>
...
// Usenew unified personalization system
    localStorage.setItem('wdp_personalization_enabled', 'true');
    localStorage.setItem('wdp_personalization_choice', 'enabled');
...
knowledgeLevel: 'beginner',
   ...
   localStorage.setItem('hasSeenGuidedTour', 'true');
    ...
    constmessage = postcode 
       ? '✅ Personalization enabled!We\'llfind local resources for you.' 
 ...
 * Makes spacing conditional basedon content presence* Fixesblank space issue betweencivic and jobs sections
*/
...
// Toggleclass for dynamic styling
   ...
   // Set upMutationObserver to watch forcontent changes
...
// V36.4.0:REMOVED - enablePersonalizationand skipPersonalizationdeleted
