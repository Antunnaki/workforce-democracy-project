...
# Workforce Democracy Project - Quick Deployment Script
# This script performs quick deployment tasks
...
execute_on_server() {
    ...
    ssh -o PubkeyAuthentication=no ${SERVER_USER}@${SERVER_IP} "$command"
}
...
execute_on_server "curl -X GEThttp://localhost:3001/health"
